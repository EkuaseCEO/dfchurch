...
export default function UpdatePost() {
  ...
  return (
    <div className='p-3 max-w-5xl mx-auto min-h-screen'>
      <h1 className='text-center text-3xl my-7 font-semibold'>Update Front Page Setting {formData._id}  </h1>
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        ...
        />
        <Button type='submit' gradientDuoTone='purpleToPink' className='mb-11'>
          Update post
        </Button>
        {publishError && (
